...
- First use of `/pipe` in a project
...
```bash
mkdir -p .dev-pipe/context/{project,systems,tech,experience/{bug,performance,feature,process},rules}
mkdir -p .dev-pipe/workspace
```
...
3. Start: /pipe implement {your first feature}
```
